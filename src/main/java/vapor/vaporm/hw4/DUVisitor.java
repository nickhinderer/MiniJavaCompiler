...
public class DUVisitor extends VInstr.VisitorPR<Integer, vapor.vaporm.hw4.Node, RuntimeException> {
    public DUVisitor() {
    }

    public vapor.vaporm.hw4.Node visit(Integer num, VAssign assign) {
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VCall call) {
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
        node.instruction = call;
        VVarRef.Local dest = call.dest;
        if (dest != null) { node.addDef(Variable.variable(dest.toString())); node.addUse(Variable.variable(dest.toString()));}
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VBuiltIn builtIn) {
        if (num == 11)
            System.out.println();
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
        ...
        return new vapor.vaporm.hw4.Node(num);
    }

    public vapor.vaporm.hw4.Node visit(Integer num, VMemWrite write) {
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VMemRead read) {
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
...
//        if (!(dest instanceof ))
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VBranch branch) {
        vapor.vaporm.hw4.Node node = new vapor.vaporm.hw4.Node(num);
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VGoto _goto) {
...
//            node.addUse(new Variable(_goto.target.toString()));
    ...
    public vapor.vaporm.hw4.Node visit(Integer num, VReturn ret) {
        vapor.vaporm.hw4.Node node = new Node(num);
